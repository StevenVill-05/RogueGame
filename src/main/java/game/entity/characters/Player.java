 ...
 * Holds stats (HP, attack, gold, kills), position, the sprite path used by GameView,
 * and the list of up to three skills that each subclass populates in its constructor.
 *
 * Subclasses (Warrior, Rogue, Mage) override stats via super() and register skills
 * with {@link #addSkill(Skill)}.  GameView renders whichever sprite path is set via
 * {@link #setSpritePath(String)}.
 */
public class Player {
    private int x, y;
