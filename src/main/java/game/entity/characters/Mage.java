...
/**
 * The Mage is a glass-cannon caster with very high attack but low HP.
 * Skills are primarily instant or teleport-based, favouring area damage
 * and repositioning over direct melee.
 *
 * <pre>
 *   HP: 8  |  ATK: 8  (per hit — easily the highest base damage)</pre>
 *
 * Skills (unlocked with gold):
 * <ul>
 *   <li>[1] Fireball (instant, 15g, CD 6) — blast every visible enemy for 5 dmg.</li>
 *   <li>[2] Blink (directional, 30g, CD 8) — teleport exactly 3 tiles; all tiles must be open.</li>
 *   <li>[3] Drain Life (directional, 45g, CD 5) — steal 4 HP from an adjacent enemy.</li>
 * </ul>
 */
