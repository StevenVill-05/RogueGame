...
/**
 * The Warrior is a durable melee fighter with high HP and moderate attack.
 * Specialises in directional, crowd-control skills that reward choosing
 * the right target rather than spamming abilities.
 *
 * <pre>
 *   HP: 20  |  ATK: 2  (per hit)
 * </pre>
 *
 * Skills (unlocked with gold; all three can be earned in a single run):
 * <ul>
 *   <li>[1] Shield Bash (directional, 15g, CD 4) — slam an adjacent enemy for 4 dmg, or
 *       brace for 3 HP if the tile is empty.</li>
 *   <li>[2] War Cry (instant, 25g, CD 5) — deal 2 dmg to every visible enemy at once.</li>
 *   <li>[3] Cleave (directional, 40g, CD 5) — sweep a 3-tile line dealing 2× attack damage.</li>
 * </ul>
 */
