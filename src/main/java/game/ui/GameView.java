...
public class GameView {
     ...
     * The most recent message is shown at full brightness; older ones are dimmed.
     *
     * @param gc       graphics context
     * @param msgFont  font for message text
     * @param hudH     height of the top HUD bar (used to compute the bar's Y position)
     * @param tileSize current tile size (used to compute the bar's Y position)
     * @param msgH     height of the message bar in pixels
